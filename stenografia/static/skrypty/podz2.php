...
// KONIEC ZAMIAN
//DODATKOWE ZAMIANY
$tekst = str_replace("f", "w", $tekst);
$tekst = str_replace("d", "t", $tekst);
$tekst = str_replace("g", "k", $tekst);
$tekst = str_replace("ł", "l", $tekst);
$tekst = str_replace("b", "p", $tekst);
$tekst = str_replace("ź", "ś", $tekst);
$tekst = str_replace("ď", "ć", $tekst);
$tekst = str_replace("đ", "u", $tekst);
$tekst = str_replace("#", "ż", $tekst);
$tekst = str_replace("ç", "č", $tekst);


//KONIEC DODATKOWYCH ZAMIAN
